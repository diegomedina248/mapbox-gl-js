...
export type LayoutProps = {|
    ...
    "variable-text-offset": DataDrivenProperty<number>,
    "variable-text-anchor": DataConstantProperty<Array<"center" | "left" | "right" | "top" | "bottom" | "top-left" | "top-right" | "bottom-left" | "bottom-right">>,
    "variable-text-anchor-animation": DataConstantProperty<boolean>,
...
const layout: Properties<LayoutProps> = new Properties({
    ...
    "variable-text-offset": new DataDrivenProperty(styleSpec["layout_symbol"]["variable-text-offset"]),
    "variable-text-anchor": new DataConstantProperty(styleSpec["layout_symbol"]["variable-text-anchor"]),
    "variable-text-anchor-animation": new DataConstantProperty(styleSpec["layout_symbol"]["variable-text-anchor-animation"]),
